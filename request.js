...
const BACKEND_URL = `${process.env.REACT_APP_GRAPHQL_HOST_PROTOCOL}://${process.env.REACT_APP_GRAPHQL_HOST_SERVER}/${process.env.REACT_APP_GRAPHQL_HOST_VERSION}/${process.env.REACT_APP_GRAPHQL_HOST_ENDPOINT}`;
const header = {
  headers: {
